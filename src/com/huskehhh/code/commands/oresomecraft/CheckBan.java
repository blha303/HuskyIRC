        ...
        try {
            ...
            if (parse != null) {
                ...
                if (parse.getString("banned") == null) {
                    return player + " is " + Colors.GREEN + "not banned" + Colors.REVERSE + " from " + server;
                } else {
                    return player + " is" + Colors.RED + " banned" + Colors.REVERSE + " from " + server + ", banned by " + parse.getString("banned_by") + " for the reason of '" + parse.getString("ban_reason") + "'.";
                }
